...
function removeTimestamps(text: string): string {
  // Regex to match timestamps like [123.45s] or [123s]
  return text.replace(/\[\d+(\.\d+)?s\]\s*/g, "");
}
...
export const generateAISermonBreakdown = async (
  ...
  try {
    ...
    const example = `
  <div><h3>Detailed Breakdown</h3>  <h4>Summary</h4> <p>This sermon titled <strong>"It Is Written"</strong> emphasizes the <em>authority of God's Word</em>. Drawing from <strong>2 Corinthians 4:13</strong>, the message teaches that faith works by believing in the heart and confessing with the mouth. [<a href="https://www.youtube.com/watch?v=ByUBNepThs&t=0">00:00:00</a>]</p>  <h4>Introduction (0:00 - 5:30)</h4> <p>The pastor opens by reading <strong>Isaiah 55:10-11</strong>, establishing that God's Word never fails. [<a href="https://www.youtube.com/watch?v=ByUBNepThs&t=11">00:00:11</a>]</p>  <h4>Core Concepts</h4> <ol> <li><strong>God's Word Cannot Fail</strong> — Like rain watering the earth, His Word brings fruit. [<a href="https://www.youtube.com/watch?v=ByUBNepThs&t=10">00:00:10</a>]</li>  <li><strong>God's Desire for All</strong> — God wants all people to be saved and come to the knowledge of truth. [<a href="https://www.youtube.com/watch?v=ByUBNepThs&t=313">00:05:13</a>]</li>  <li><strong>It Is Written — The Spirit of Faith</strong> — Faith must be voiced. If you don't speak, you limit what God can do. [<a href="https://www.youtube.com/watch?v=ByUBNepThs&t=830">00:13:50</a>]</li> </ol>  <h4>Breakthrough Ideas</h4> <ol> <li><strong>Faith Speaks or Dies</strong> — Silent faith is dead faith. "You shut your mouth, you shut your life." [<a href="https://www.youtube.com/watch?v=ByUBNepThs&t=880">00:14:40</a>]</li> </ol>  <h4>Key Connections</h4> <ul> <li><strong>Word → Faith → Confession → Manifestation:</strong> Every miracle follows this chain. [<a href="https://www.youtube.com/watch?v=ByUBNepThs&t=900">00:15:00</a>]</li> </ul>  <h4>Actionable Advice</h4> <ol> <li><strong>Speak the Word Daily</strong> — Declare Scriptures over every area of your life. [<a href="https://www.youtube.com/watch?v=ByUBNepThs&t=830">00:13:50</a>]</li> </ol>  <h4>Conclusion (49:00 - 54:00)</h4> <p>The sermon closes with a reminder that believers have one life to live for God's purpose. [<a href="https://www.youtube.com/watch?v=ByUBNepThs&t=3060">00:51:00</a>]</p> </div>
  `;
    const modelPrompt = `
